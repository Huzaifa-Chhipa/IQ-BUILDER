...
export default function Careers() {
  return (
    <div className="bg-navy-deep min-h-screen text-white">
      <Navbar />
      <main className="pt-24 pb-24 container mx-auto px-4 md:px-12">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="max-w-4xl mx-auto w-full"
        >
          <h1 className="text-4xl md:text-7xl font-display font-light text-center mb-10 md:mb-16">
          ...
          <div className="glass-dark p-6 md:p-12 rounded-[20px] border border-white/10 space-y-10 md:space-y-12">
            <section>
              ...
              <p className="text-white/60 leading-relaxed mt-4 text-sm md:text-base">
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4 md:gap-8">
                {[
                  ...
                  <div key={i} className="bg-white/5 p-5 md:p-6 rounded-xl border border-white/5">
            ...
            <section>
              ...
              <p className="text-white/60 mb-6 text-sm md:text-base">We welcome talented individuals from various backgrounds:</p>
            ...
            <section>
              ...
              <a 
                ...
                className="inline-block px-6 md:px-8 py-3 md:py-4 bg-gold text-black font-bold uppercase tracking-widest text-xs md:text-sm rounded-full hover:bg-gold/90 transition-all text-center"
              >
