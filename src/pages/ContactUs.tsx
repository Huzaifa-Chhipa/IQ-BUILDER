            ...
            <div className="space-y-8 md:space-y-10 w-full">
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/60 font-light mb-4 break-all">Office number 5046, Central Plaza Shopping Mall, Marstan Road, Karachi</p>
                  <p className="text-white/60 font-light break-all">Office number 35 and 36, Alharam Center, near Ancle Seria Hospital, Karachi</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 md:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-white/60 font-light break-all">hasnainqadriiqbuilders@gmail.com <br /> (Encrypted Channel)</p>
                </div>
              </div>
            </div>
